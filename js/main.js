...
document.addEventListener('DOMContentLoaded', function() {
    new Typed('.home_title #subtitle', {
        strings: ['Hi, I am a certified Python Web Developer.', 'I have experience in creating websites and applications using Python.', 'I like to do web applications using Django and Flask frameworks.', 'I am knowledgeable in front-end (HTML, CSS, JS) and back-end development.'],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
